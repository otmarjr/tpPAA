...
${OBJECTDIR}/aresta_nomain.o: ${OBJECTDIR}/aresta.o aresta.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aresta_nomain.o aresta.cpp;\
	else  \
...
${OBJECTDIR}/vertice_nomain.o: ${OBJECTDIR}/vertice.o vertice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vertice_nomain.o vertice.cpp;\
	else  \
