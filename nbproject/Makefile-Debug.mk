...
${OBJECTDIR}/aresta.o: aresta.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aresta.o aresta.cpp
...
${OBJECTDIR}/projeto_software.o: projeto_software.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/projeto_software.o projeto_software.cpp

${OBJECTDIR}/union_find.o: union_find.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/union_find.o union_find.cpp
...
${OBJECTDIR}/aresta_nomain.o: ${OBJECTDIR}/aresta.o aresta.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aresta_nomain.o aresta.cpp;\
	else  \
...
${OBJECTDIR}/grafo_nomain.o: ${OBJECTDIR}/grafo.o grafo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/grafo_nomain.o grafo.cpp;\
	else  \
...
${OBJECTDIR}/projeto_software_nomain.o: ${OBJECTDIR}/projeto_software.o projeto_software.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/projeto_software_nomain.o projeto_software.cpp;\
	else  \
...
${OBJECTDIR}/union_find_nomain.o: ${OBJECTDIR}/union_find.o union_find.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/union_find_nomain.o union_find.cpp;\
	else  \
...
${OBJECTDIR}/vertice_nomain.o: ${OBJECTDIR}/vertice.o vertice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vertice_nomain.o vertice.cpp;\
	else  \
